...
const localizedApiErrors: Record<ApiErrorCode, string> = {
  ...
  LIBRARY_LOCKED: "ライブラリをロック解除してください。",
  LIBRARY_NOT_ENCRYPTED: "この操作は暗号化ライブラリにのみ対応しています。",
  INVALID_LIBRARY_PASSWORD: "パスワードが正しくありません。",
  UNSUPPORTED_BOOK_FORMAT: "このファイル形式は追加できません。",
  IMPORT_FAILED: "ファイルを追加できませんでした。",
